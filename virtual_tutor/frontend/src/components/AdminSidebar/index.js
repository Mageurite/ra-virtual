...
const menuItems = [
  { key: 'tutors', label: 'Tutors', icon: <School style={{ fontSize: 20 }} /> },
  { key: 'students', label: 'Students', icon: <Person style={{ fontSize: 20 }} /> },
  { key: 'audit', label: 'Audit Logs', icon: <Notifications style={{ fontSize: 20 }} /> },
];
